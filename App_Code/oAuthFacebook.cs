...
public class oAuthFacebook
{
        ...
        public const string CALLBACK_URL = "http://jhalak.com/FBCallBack.aspx";
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                _consumerKey = "293009461136512"; //Your application ID
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                _consumerSecret = "shaileshjhalak"; //Your application secret
                }
        ...
        public string WebRequest(Method method, string url, string postData)
        {
            ...
            webRequest.UserAgent = "http://jhalak.com/mypost.aspx";
