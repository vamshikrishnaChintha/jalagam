<%@ Page Title="" Language="C#" MasterPageFile="~/Post-Ad.master" AutoEventWireup="true" CodeFile="Edit-Branches.aspx.cs" Inherits="Edit_Branches" %>
            ...
            <div class="desc-page">
                <div class="row margin jhkfrm">
                    <div class="col-sm-7 login-centered">
                        ...
                        <h3 class="h-tag padding">Edit Branch Details</h3>
                        <div class="pane-txt">
