<%@ Page Title="" Language="C#" MasterPageFile="~/Post-Ad.master" AutoEventWireup="true" CodeFile="Edit-Photo-Gallery.aspx.cs" Inherits="Edit_Photo_Gallery" %>
        ...
        <div class="desc-page">
            <div class="row margin jhkfrm">
                <div class="col-sm-7 login-centered">
                    ...
                    <h3 class="h-tag padding">Edit Photo Gallery</h3>
                    <div class="pane-txt">
                ...
                <div class="txtcenter row">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="&#xf1d8; Updadte" Style="font-family: CustomFont, FontAwesome;"
