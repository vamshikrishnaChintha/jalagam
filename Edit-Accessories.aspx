<%@ Page Title="" Language="C#" MasterPageFile="~/Post-Ad.master" AutoEventWireup="true" CodeFile="Edit-Accessories.aspx.cs" Inherits="Edit_Accessories" %>
            ...
            <div class="desc-page">
                <div class="row margin jhkfrm">
                    <div class="col-sm-7 login-centered">
                        ...
                        <h3 class="h-tag padding">Edit Accessories</h3>
                        <div class="pane-txt">
                            ...
                            <div class="post-ad-frm margin-bottom">
                                ...
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        <asp:TextBox runat="server" ID="txtProductCode" MaxLength="20" ReadOnly="true" Placeholder="&#xf007; Add Product Code"
                                            Style="font-family: CustomFont, FontAwesome"></asp:TextBox>
                                        <%--<cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" TargetControlID="RequiredFieldValidator1" Width="220" runat="server" CloseImageUrl="images/alert-close.png" WarningIconImageUrl="images/alert-img.png" />--%>
                            ...
                            <div class="post-ad-frm margin-bottom">
                                <div class="padding border-bottom" style="background: #efefef; border-top: 2px solid #e21c04">
                                    <h3 class="h-tag padding">
                                        <b>Upload Accessories<span style="color: #f60" ></span></b></h3>
                                </div>
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        <a name="Images"></a>
                    ...
                    <div class="txtcenter row">
                        ...
                        <asp:Button ID="btnSubmit" runat="server" Text="&#xf1d8; Update" Style="font-family: CustomFont, FontAwesome;"
