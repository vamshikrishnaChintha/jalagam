...
public partial class Add_Accessories : System.Web.UI.Page
{
    ...
    private void Save()
    {
        ...
        dbJalagam.Accessories_Masters.InsertOnSubmit(objK);
            ...
            if (hpf.ContentLength > 0)
            {
                if (hpf.ContentLength < 5307200)
                {
                    ...
                    if ((Ext == ".png") || (Ext == ".PNG") || (Ext == ".jpg") || (Ext == ".JPG") || (Ext == ".jpeg") || (Ext == ".JPEG") || (Ext == ".bmp") || (Ext == ".gif"))
                    {
                        if(i==0)
                        {
                            String UploadedFile1 =Convert.ToString(MaxGalleryId)+".jpg";
                            int ExtractPos = UploadedFile1.LastIndexOf("\\") + 1;

                            //to retrieve only Filename from the complete path
                            String UploadedFileName = UploadedFile1.Substring(ExtractPos, UploadedFile1.Length - ExtractPos);
