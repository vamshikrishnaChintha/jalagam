<%@ Page Title="" Language="C#" MasterPageFile="~/Post-Ad.master" AutoEventWireup="true" CodeFile="Add-Product.aspx.cs" Inherits="Add_Product" %>
            ...
            <div class="desc-page">
                <div class="row margin jhkfrm">
                    <div class="col-sm-8 login-centered">
                        ...
                        <h3 class="h-tag padding">Add Product</h3>
                        <div class="pane-txt">
                            ...
                            <div class="post-ad-frm margin-bottom">
                                ...
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        <asp:TextBox runat="server" ID="txtProductCode" MaxLength="100" Placeholder="&#xf007; Add Product Code"
                            ...
                            <div class="post-ad-frm margin-bottom">
                                ...
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        <asp:TextBox runat="server" ID="txtDesc" MaxLength="1000" TextMode="MultiLine" Placeholder="&#xf007; Add Description"
                                            Style="font-family: CustomFont, FontAwesome"></asp:TextBox>
                            ...
                            <div class="post-ad-frm margin-bottom">
                                ...
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ValidationGroup="VgGroup" ControlToValidate="fupDisplayImage" ErrorMessage="Display Image is Required!" Display="Dynamic" CssClass="err-class" ForeColor="Red" runat="server" />
                            ...
                            <div class="post-ad-frm margin-bottom">
                                <div class="padding border-bottom" style="background: #efefef; border-top: 2px solid #e21c04">
                                    <h3 class="h-tag padding">
                                        <b>Upload Product<span style="color: #f60" title="Required">*</span></b></h3>
                                </div>
                                <div class="row padding">
                                    <div class="col-sm-8">
                                        <a name="Images"></a>
                                       ...
                                       <%-- <asp:FileUpload ID="fupProducts" class="multi" accept=".png,.jpg,.jpeg,.gif" runat="server" ViewStateMode="Enabled" />--%>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ValidationGroup="VgGroup" ControlToValidate="fupProducts" ErrorMessage="Photo is Required!" Display="Dynamic" CssClass="err-class" ForeColor="Red" runat="server" />
