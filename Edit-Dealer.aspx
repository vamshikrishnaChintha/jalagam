<%@ Page Title="" Language="C#" MasterPageFile="~/Post-Ad.master" AutoEventWireup="true" CodeFile="Edit-Dealer.aspx.cs" Inherits="Edit_Dealer" %>
            ...
            <div class="desc-page">
                <div class="row margin jhkfrm">
                    <div class="col-sm-9 login-centered">
                        <h3 class="h-tag padding">Edit Dealer</h3>
                        <div class="pane-txt">
                            ...
                            <div class="post-ad-frm margin-bottom">
                                ...
                                <div class="row padding">
                                    ...
                                    <%--  <asp:TextBox runat="server" ID="txtBatteryType" MaxLength="100" Placeholder="&#xf007; Add Battery Type"
                                            Style="font-family: CustomFont, FontAwesome"></asp:TextBox>--%>
                                </div>
                            </div>
                        </div>
